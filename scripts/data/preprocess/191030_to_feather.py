...
# convert timestamp
with timer("converting timestamp"):
...
with timer("saving as feather"):
    ...
    building_metadata.to_feather(DATA_FEATHER + "building_metadata.feather")